...
final class ExerciseLibraryRepositoryTests: XCTestCase {
    ...
    func testRecentExerciseOptionsInfersMuscleGroupWhenBlank() async throws {
        let mock = InMemoryExerciseLibraryRepository()
        await mock.setExerciseRows([
    ...
    func testRecentExerciseOptionsUsesProfilePrimaryNotTopWeightedTargetRegion() async throws {
    ...
    func testRecentExerciseOptionsFallsBackToCoreWhenNoMuscleMatch() async throws {
        let mock = InMemoryExerciseLibraryRepository()
        await mock.setExerciseRows([
